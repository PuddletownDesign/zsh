...
autoload -Uz _n-kill _docker _brew _brew_cask _git \
            _packer _tig _youtube-dl _SUSEconfig _a2ps \
            _a2utils _aap _abcde _absolute_command_paths _ack \
            _acpi _acpitool _acroread _adb _add-zle-hook-widget \
            _add-zsh-hook _alias _aliases _all_labels _all_matches \
            _alsa-utils _alternative _analyseplugin _ansible _ant \
            ...
            _arrays _asciidoctor _asciinema _assign _at \
            _attr _augeas _auto-apt _autocd _avahi \
            ...
            _brctl _bsd_disks _bsd_pkg _bsdconfig _bsdinstall \
            ...
            _chmod _chown _chroot _chrt _chsh \
            _cksum _clay _cmdambivalent _cmdstring _cmp \
            _code _column _combination _comm _command \
            _command_names _comp_locale _compadd _compdef _complete \
            _complete_debug _complete_help _complete_help_generic _complete_tag _completers \
            ...
            _cscope _cssh _csup _ctags_tags _cu \
            _curl _cut _cvs _cvsup _cygcheck \
            _cygpath _cygrunsrv _cygserver _cygstart _dak \
            _darcs _date _date_formats _dates _dbus \
            _dchroot _dchroot-dsa _dconf _dcop _dcut \
            _dd _deb_architectures _deb_codenames _deb_files _deb_packages \
            ...
            _file_systems _files _find _find_net_interfaces _findmnt \
            _finger _fink _first _flac _flex \
            _floppy _flowadm _fmadm _fmt _fold \
            _fortune _free _freebsd-update _fs_usage _fsh \
            _fstat _functions _fuse_arguments _fuse_values _fuser \
            _fusermount _fw_update _gcc _gcore _gdb \
            ...
            _my_accounts _myrepos _mysql_utils _mysqldiff _nautilus \
            ...
            _nothing _npm _nslookup _numfmt _nvram \
            _objdump _object_classes _object_files _obsd_architectures _od \
            _okular _oldlist _open _openstack _opkg \
            _options _options_set _options_unset _osascript _osc \
            _other_accounts _otool _pack _pandoc _parameter \
            ...
            _pkg5 _pkg_instance _pkgadd _pkgin _pkginfo \
            _pkgrm _pkgtool _plutil _pmap _pon \
            _portaudit _portlint _portmaster _ports _portsnap \
            _postfix _postgresql _postscript _powerd _precommand \
            ...
            _pump _putclip _pv _pwgen _pydoc \
            _python _python_modules _qdbus _qemu _qiv \
            _qtplay _quilt _rake _ranlib _rar \
            _rcctl _rclone _rcs _rdesktop _read \
            ...
            _sc_usage _sccs _sched _schedtool _schroot \
            ...
            _setopt _setsid _setup _setxkbmap _sh \
            ...
            _sw_vers _swaks _swanctl _swift _sys_calls \
            ...
            _timeout _tin _tla _tload _tmux \
            _todo.sh _toilet _toolchain-source _top _topgit \
            _totd _touch _tpb _tput _tr \
            _tracepath _transmission _trap _trash _tree \
            _truss _tty _ttyctl _ttys _tune2fs \
            _twidge _twisted _typeset _ulimit _uml \
            _umountable _unace _uname _unexpand _unhash \
            _uniq _unison _units _update-alternatives _update-rc.d \
            _uptime _urls _urpmi _urxvt _uscan \
            ...
            _vpnc _vserver _w _w3m _wait \
            _wajig _wakeup_capable_devices _wanna-build _wanted _watch \
            _watch-snoop _wc _webbrowser _wget _whereis \
            _which _who _whois _widgets _wiggle \
            _wipefs _wpa_cli _x_arguments _x_borderwidth _x_color \
            ...
            _x_window _xargs _xauth _xautolock _xclip \
            _xcode-select _xdvi _xfig _xft_fonts _xloadimage \
            _xmlsoft _xmlstarlet _xmms2 _xmodmap _xournal \
            _xpdf _xrandr _xscreensaver _xset _xt_arguments \
            _xt_session_id _xterm _xv _xwit _xxd \
            _xz _yafc _yast _yodl _yp \
            ...
            _zoneadm _zones _zparseopts _zpool _zpty \
