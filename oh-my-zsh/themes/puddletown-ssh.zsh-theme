...
PROMPT='
%{$fg_bold[black]%}%{$bg_bold[black]%} SSH %{$fg_bold[black]%}%{$bg_bold[yellow]%} DEV %{$reset_color%}%{$fg_bold[cyan]%} %m ➤ %{$fg_bold[magenta]%}%~ %{$fg_bold[cyan]%}$(git_prompt_info)%{$fg_bold[blue]%} % %{$reset_color%}
